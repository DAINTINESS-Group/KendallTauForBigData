...
java -Xmx4608m -cp parallel-kendalls-tau-1.0-SNAPSHOT.jar:lib/* gr.archimedesai.centralized.approximate.MainAdaptiveApproximate data/radiation-small.csv 0 2 , 3.5 1.0 90.1 1351.1 50 50 timeExec-approx-gridAdaptive-radiation${j}.txt data/samples/radiation-small.csv -0.9799336217601233
