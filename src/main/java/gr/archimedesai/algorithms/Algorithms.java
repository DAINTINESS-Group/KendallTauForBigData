...
//        System.out.println("X and XY ties time "+(t - t1)+" ms, "+ "Pure knight "+(t2 - t)+" ms, "+ "Y and XY time "+(System.currentTimeMillis() - t2)+" ms");
...
//                }
                ...
                counterPairsWithOtherAttributeLarger += ((long) (numberTuplesTile2 - cursor2)*(cursor1 - startI));
                counterTieOnOtherAttribute += ((long) (cursor1 - startI)*(cursor2 -startJ));
