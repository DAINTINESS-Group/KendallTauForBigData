...
import grarchimedesai.archimedesai.centralized.grid.AdaptiveGrid;
...
public class MainAdaptiveGrid {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AdaptiveGrid grid = AdaptiveGrid.newAdaptiveGrid(Rectangle.newRectangle(Point.newPoint(Double.parseDouble(args[4]),Double.parseDouble(args[5])),Point.newPoint(Double.parseDouble(args[6]),Double.parseDouble(args[7]))),cellsInXAxis, cellsInYAxis,samplesPairs);
